...
# from mt5api.client.error import MetaTrader5ClientErrorMixin
from nautilus_mt5.client.common import (
    AccountOrderRef,
    Request,
    Requests,
    Subscriptions,
...
class MetaTrader5Client(
    ...
    MetaTrader 5. It inherits from `Component` to provide
    ...
    def __init__(
        ...
        cache: Cache,
        clock: LiveClock,
        config: MetaTrader5ExtConfig = MetaTrader5ExtConfig(),
        client_id: int = 1,
    ) -> None:
        super().__init__(
            clock=clock,
